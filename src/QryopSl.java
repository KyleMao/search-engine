/**
 * All query operators that return score lists are subclasses of the QryopSl class. This class has
 * two main purposes. First, it allows query operators to easily recognize any nested query operator
 * that returns a score list (e.g., #AND (a #OR (b c)). Second, it is a place to store data
 * structures and methods that are common to all query operators that return score lists.
 * 
