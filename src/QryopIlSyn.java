/**
 * This class implements the SYN operator for all retrieval models. The synonym operator creates a
 * new inverted list that is the union of its constituents. Typically it is used for morphological
 * or conceptual variants, e.g., #SYN (cat cats) or #SYN (cat kitty) or #SYN (astronaut cosmonaut).
 *
